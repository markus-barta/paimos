...
export function resolveSettingsTab(queryTab: SettingsQueryTab | undefined): SettingsTab {
  if (queryTab === 'branding') return 'appearance'
  return queryTab && SETTINGS_TAB_IDS.has(queryTab as SettingsTab) ? (queryTab as SettingsTab) : 'account'
}
