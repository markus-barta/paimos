...
| **gosec baseline count** | `.gosec-baseline.txt` line count | 0 (baseline empty since PAI-223 closed, 2026-06-11) | SAST regression direction; any finding blocks CI |
...
- gosec baseline burn-down pending PAI-223 *(closed 2026-06-11 — baseline empty)*
