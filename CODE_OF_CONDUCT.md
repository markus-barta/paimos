...
PAIMOS follows the [Contributor Covenant][covenant], version 2.1.

## Our pledge

In the interest of fostering an open and welcoming environment,
contributors and maintainers pledge to make participation in PAIMOS a
...
be reported to the maintainers at **`conduct@paimos.com`**. All
